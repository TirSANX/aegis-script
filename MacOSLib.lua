--[=[
    ...
    -- 🚀 NEW FEATURES --
    - Added handle-less resizing (hover on any edge or corner)
    - Mouse icon now changes when hovering over a resizable edge
    - Made internal elements (sidebar, workarea) resize with the main window
    
    -- 🚀 STYLING UPDATE (v9) --
    - 🚀 FIXED: Column splitting logic now uses UIGridLayout to fill columns correctly.
    - 🚀 FIXED: Components resized back to 37px height.
    - 🚀 NEW: Columns are now dynamic (1, 2, or 3) based on window width.
    - Kept macOS buttons styling changes from v8.
    - Added new sec:Header component with gradient
    - REBUILT sec:Switch with "Glow" style
    - UPDATED: Sidebar sections now have Title + Subtitle
    - UPDATED: Sidebar scrollbar is visible and themed
    - UPDATED: Selection bar is now on the right
    - UPDATED: Search now checks title and subtitle
    
    -- 🚀 BUG FIXES (v10) --
    - 🚀 FIXED: 'AbsolutePosition' nil error in updateChildSizes.
    - 🚀 FIXED: 'PaddingRight' UDim2 error in sec:Dropdown.
    - 🚀 FIXED: Maximize/Restore button now correctly re-runs the column logic.
    - 🚀 FIXED: All invisible "U+a0" unicode characters replaced with standard spaces.

    -- 🚀 STYLING (v12 - v23) --
    - 🚀 FIXED: Increased vertical list padding for better component spacing.
    - 🚀 FIXED: Changed component split from 40/60 to 50/50 for more title room.
    - 🚀 UPDATED: PC/Mobile hidden indicators are larger and opaque (Transparency = 0).
    - 🚀 UPDATED: Removed custom scrollbar and themed the default Roblox scrollbar.
    - 🚀 UPDATED: Added padding to the right of the main content area to prevent scrollbar overlap.
    - 🚀 UPDATED: Changed scrollbar color to `Theme.Colors.Text` (white grey).
    - 🚀 UPDATED: Changed subtitle to "Premium script by AEGIS CORE".
    - 🚀 UPDATED: Added an inner border to the main window to match the logo's style.
    - 🚀 FIXED: Corrected inner border layering issue so it's visible.
    - 🚀 UPDATED: Increased right-side padding in content area to move text away from scrollbar.
    - 🚀 UPDATED: UI is now smaller by default on mobile devices.
]=]
...
local Theme = {
    Colors = {
        -- Main Palette (Dark Grey/Purple Theme)
        MainBack = Color3.fromRGB(20, 20, 23),      -- 🚀 Darker background
        ContentBack = Color3.fromRGB(25, 25, 28),   -- 🚀 Darker content background
        Primary = Color3.fromRGB(139, 92, 246),     -- Your vibrant purple
        PrimaryLight = Color3.fromRGB(160, 120, 255), -- Lighter purple for gradients
        Success = Color3.fromRGB(139, 92, 246),     -- Use Primary color for success (toggles, etc.)
        Gray = Color3.fromRGB(45, 45, 50),      -- 🚀 Darker Dividers, lines
        LightGray = Color3.fromRGB(35, 35, 40),   -- 🚀 Darker Textbox/component background

        -- Text
        Text = Color3.fromRGB(180, 180, 185),       -- 🚀 Softer body text
        TextDark = Color3.fromRGB(255, 255, 255),     -- Titles, main text
        TextLight = Color3.fromRGB(255, 255, 255), -- Text on dark/primary backgrounds

        -- 🚀 RE-ADDED: macOS Buttons (Kept original colors per request)
    ...
    Sizes = {
        LargeRadius = UDim.new(0, 12), -- 🚀 Reduced radius for sharper look
        SmallRadius = UDim.new(0, 6),
        FullRadius = UDim.new(1, 0),
        SwitchRadius = UDim.new(0, 4) -- 🚀 For Checkbox
    }
}
...
local CollectionService = game:GetService("CollectionService") -- Use for tagging
...
local sections = {}
local workareas = {}
local sectionAPIs = {} -- 🚀 v11: Store section APIs (like :Select())
local notifs = {}
local visible = true
...
-- 🚀 NEW: Function to create the gradient for headers
...
function lib:init(ti, sub_ti, dosplash, visiblekey, deleteprevious)
    ...
    local sidebar
    local search
    local logo -- 🚀 Forward declare logo
    local window = {} -- 🚀 Declared at the top
    local notifdarkness, notif2darkness -- Forward declare for resizing
    
    -- 🚀 NEW: State variables for resizing
    -- 🚀 v23: Check for touch device to set smaller min/default size
    local isMobile = UserInputService.TouchEnabled
    local minSize = isMobile and Vector2.new(650, 400) or Vector2.new(850, 600) -- 🚀 Smaller min width for mobile
    local defaultSize = isMobile and Vector2.new(650, 400) or Vector2.new(850, 600) -- 🚀 Smaller default for mobile
    ...
    if syn then
        if CoreGui:FindFirstChild("ScreenGui") and deleteprevious then
            tp(CoreGui.ScreenGui.main, CoreGui.ScreenGui.main.Position + UDim2.new(0, 0, 2, 0), 0.5)
            Debris:AddItem(CoreGui.ScreenGui, 1)
        end
    ...
    elseif gethui then
        ...
        if hui:FindFirstChild("ScreenGui") and deleteprevious then
            ...
            Debris:AddItem(hui.ScreenGui, 1)
        end
        scrgui = Instance.new("ScreenGui")
        scrgui.Parent = hui
    else
    ...
    local loadingScreen
    local progressBar
    local function updateLoadingProgress(statusText, progress) -- progress is 0 to 1
    ...
    if dosplash then
        -- 🚀 NEW: Add a background blur effect
        ...
        -- 🚀 NEW: Function to show random tips
        ...
        logo.ZIndex = 1001 -- 🚀 Ensure logo is drawn on top
        ...
        progressBar.BackgroundColor3 = Theme.Colors.Primary -- 🚀 Use new theme color
        progressBar.ZIndex = 1002
        
        createGradient(progressBar, Theme.Colors.Primary, Theme.Colors.PrimaryLight) -- 🚀 Gradient bar
    ...
    main.Size = UDim2.new(0, defaultSize.X, 0, defaultSize.Y) -- 🚀 v23: Use dynamic default size
    ...
    mainShadow.ImageTransparency = 0.5 -- 🚀 Made shadow darker (was 0.7)
    mainShadow.ScaleType = Enum.ScaleType.Slice
    mainShadow.SliceCenter = Rect.new(100, 100, 100, 100)

    -- 🚀 v21: Floating border frame
    local mainFloatingBorder = Instance.new("Frame")
    mainFloatingBorder.Name = "FloatingBorder"
    mainFloatingBorder.Parent = main
    mainFloatingBorder.BackgroundTransparency = 1 -- Completely transparent
    mainFloatingBorder.Size = UDim2.new(1, 0, 1, 0)
    mainFloatingBorder.ZIndex = 198 -- High ZIndex to draw over content

    local mainStroke = Instance.new("UIStroke")
    mainStroke.Parent = mainFloatingBorder
    mainStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
    mainStroke.Color = Color3.fromRGB(200, 200, 200) -- Light grey
    mainStroke.Thickness = 1
    mainStroke.Transparency = 0.8 -- Subtle
    ...
    hiddenIndicator.Visible = false -- Initially hidden
    hiddenIndicator.Text = ""

    -- 🚀 NEW: This is the VISUAL background, it holds all visual elements
    local hiBackground = Instance.new("Frame")
    hiBackground.Name = "BackgroundFrame"
    hiBackground.Parent = hiddenIndicator -- Parent to the hitbox
    hiBackground.BackgroundTransparency = 1 -- 🚀 v13: Made opaque
    hiBackground.BorderSizePixel = 0
    hiBackground.Size = UDim2.new(1, 0, 1, 0)
    hiBackground.ZIndex = 1
    hiBackground.ClipsDescendants = true -- 🚀 Clip children
    ...
    -- 🚀 NEW: Hover effect for the hidden indicator
    hiddenIndicator.MouseEnter:Connect(function()
        if not visible then -- Only expand if the main UI is hidden
    ...
    -- 🚀 Add a stroke to the mobile indicator
    ...
    miLogo.Size = UDim2.new(0, 45, 0, 45) -- 🚀 v13: Made bigger
    miLogo.Position = UDim2.new(0.5, 0, 0.5, 0)
    miLogo.AnchorPoint = Vector2.new(0.5, 0.5)
    miLogo.Image = "rbxassetid://101129417614969" -- Your logo asset ID

    -- Click to show the UI
    ...
    -- Drag logic (using cached UserInputService)
    local dragging
    local dragInput
    local dragStart
    local startPos
    ...
    workarea.Position = UDim2.new(0, sidebarWidth, 0, 0) -- 🚀 Positioned next to sidebar
    workarea.Size = UDim2.new(1, -sidebarWidth, 1, 0) -- 🚀 Fills remaining space
    ...
    workareacornerhider.Size = UDim2.new(0, 18, 1, 0) -- 🚀 Fixed size
    
    -- 🚀 NEW: Logo at top of sidebar
    logo = Instance.new("ImageLabel")
    logo.Name = "Logo"
    logo.Parent = main
    logo.BackgroundTransparency = 1
    logo.Image = "rbxassetid://131523188424149" -- Your logo asset ID
    logo.Size = UDim2.new(0, 150, 0, 100)
    logo.Position = UDim2.new(0, (sidebarWidth / 2) - 5, 0, 60) -- 🚀 Centered in sidebar, below macOS buttons
    logo.AnchorPoint = Vector2.new(0.4, 0) -- Anchor to center-top
    logo.ZIndex = 2
    ...
    search.Name = "search"
    search.Parent = main
    search.BackgroundColor3 = Theme.Colors.LightGray -- 🚀 Use new theme color
    search.Position = UDim2.new(0, (sidebarWidth / 2), 0, 170) -- 🚀 Positioned below logo
    search.AnchorPoint = Vector2.new(0.5, 0) -- 🚀 Center it
    search.Size = UDim2.new(0, sidebarWidth - 30, 0, 34) -- 🚀 Match sidebar padding
    ...
    searchicon.Position = UDim2.new(0, 10, 0.5, 0) -- 🚀 Centered Y, 10px left
    searchicon.AnchorPoint = Vector2.new(0, 0.5)
    searchicon.Size = UDim2.new(0, 20, 0, 20) -- 🚀 Smaller
    ...
    searchtextbox.Position = UDim2.new(0, 38, 0.5, 0) -- 🚀 Positioned right of icon
    searchtextbox.AnchorPoint = Vector2.new(0, 0.5)
    searchtextbox.Size = UDim2.new(1, -48, 1, 0) -- 🚀 Fills remaining space
    searchtextbox.Font = Theme.Fonts.Body
    searchtextbox.LineHeight = 0.870
    searchtextbox.PlaceholderText = "Search"
    searchtextbox.Text = ""
    searchtextbox.TextColor3 = Theme.Colors.Text
    searchtextbox.TextSize = 18 -- 🚀 Smaller
    ...
    -- 🚀 NEW: Function to update child sizes during resize
    -- 🚀 FIX: Moved this function *after* logo and search are defined
    local function updateChildSizes(newSize)
        ...
        if sidebar then
            ...
            local sidebarTopOffset = searchBottom - main.AbsolutePosition.Y + 10 -- 10px padding
    ...
    sidebar.Parent = main
    sidebar.Active = true
    sidebar.BackgroundTransparency = 0 -- 🚀 FIX: Make background visible for scrollbar track
    sidebar.BackgroundColor3 = Theme.Colors.MainBack -- 🚀 FIX: Blend background with main window
    sidebar.BorderSizePixel = 0
    sidebar.Position = UDim2.new(0, 10, 0, 214) -- 🚀 Positioned below search
    sidebar.Size = UDim2.new(0, sidebarWidth - 15, 1, -229) -- 🚀 Adjusted size
    sidebar.AutomaticCanvasSize = "Y"
    sidebar.CanvasSize = UDim2.new(0, 0, 0, 0)
    -- 🚀 SCROLLBAR: Made visible and themed
    sidebar.ScrollBarThickness = 3
    sidebar.ScrollBarImageColor3 = Theme.Colors.Text -- 🚀 v19: Changed to white-grey
    ...
    -- 🚀 OPTIMIZED SEARCH (Checks title and subtitle)
    searchtextbox:GetPropertyChangedSignal("Text"):Connect(function()
        ...
        for _, child in pairs(sidebar:GetChildren()) do
            if child.Name == "sidebar2" or child.Name == "sidebardivider" then
                ...
                -- Handle dividers (which have no children)
    ...
    -- 🚀 RE-ADDED: macos style buttons
    local buttons = Instance.new("Frame")
    buttons.Name = "buttons"
    buttons.Parent = main
    buttons.BackgroundTransparency = 1
    buttons.Size = UDim2.new(0, 105, 0, 57)
    buttons.Position = UDim2.new(0, 0, 0, 0) -- 🚀 Position top-left
    buttons.ZIndex = 10 -- 🚀 Make sure it's on top
    ...
    close.MouseButton1Click:Connect(function()
        window:Notify2(
            "CONFIRM CLOSE!",                    -- Title
            "Are you sure you want to destroy the UI?",     -- Text
            "CLOSE",                             -- Button 1 (Confirm)
            "CANCEL",                            -- Button 2 (Cancel)
            "rbxassetid://12608260095",             -- Icon
            function() scrgui:Destroy() end,
            function() end, -- Do nothing on cancel
            Theme.Colors.Close
        )
    end)
    ...
    topBar.Name = "TopBar"
    topBar.Parent = workarea -- 🚀 Parented to workarea
    ...
    -- 🏠 Window API
    -- ------------------------------------------------------------------------
    window.greenButtonConnection = nil -- 🚀 RE-ADDED
    ...
    function window:ToggleVisible()
        ...
        if visible then
            -- Show UI
            hiddenIndicator.Size = collapsedSize -- 🚀 FIX: Reset to collapsed size when showing UI
            if not UserInputService.TouchEnabled then -- PC only
                hiddenIndicator.Visible = false
                -- 🚀 Slide indicator OUT
                tp(hiddenIndicator, UDim2.new(1, 190, 0.7, 0), 0.3) -- 🚀 v13: FIX: Match new width
            else -- Mobile only
                mobileIndicator.Visible = false
            end
            ...
            if not UserInputService.TouchEnabled then
                hiddenIndicator.Visible = false -- 🚀 Hide after sliding out
            end
            dbcooper = false
        else
            -- Hide UI
            ...
            task.wait(0.5)
            if not UserInputService.TouchEnabled then -- PC only
                hiddenIndicator.Size = collapsedSize -- 🚀 Ensure it's collapsed
    ...
    if visiblekey then
        -- 🚀 RE-ADDED: Minimize button toggles visibility
        minimize.MouseButton1Click:Connect(function()
            if not UserInputService.TouchEnabled then
                window:ToggleVisible()
            end
    ...
    -- 🚀 RE-ADDED: Green button now toggles Maximize/Restore
    function window:GreenButton(callback)
        ...
        window.greenButtonConnection = resize.MouseButton1Click:Connect(function()
            ...
            if isMaximized then
                ...
                local newSize = viewportSize * 0.9 -- 90% of screen
                local newPos = UDim2.new(0.5, 0, 0.5, 0) -- Center
                ...
                updateChildSizes(newChildSize) -- Update children to match
                
            else
                -- Restore to original state
                if not originalSize then isMaximized = false; return end -- Safety check
            ...
            -- 🚀 NEW: Re-select the current section to apply/revert layout changes
            task.wait(tweenTime) -- Wait for window resize animation
            task.wait() -- 🚀 v10: Wait one extra frame for AbsoluteSize to update
            
            for i, section in ipairs(sections) do
                local workarea = workareas[i]
                if workarea and workarea.Visible then
                    -- 🚀 v11: FIX: Directly call the stored :Select() API for the visible section
            ...
            -- Still run the original callback if it exists
            if callback then
                task.spawn(callback, isMaximized) -- Pass the new state (true=maximized, false=restored)
            end
        end)
    end
    ...
    -- 🚀 MODIFIED: Added 'b1Color' as an optional 8th argument
    ...
    function window:Divider(name)
        ...
        sidebardivider.Size = UDim2.new(1, 0, 0, 26) -- 🚀 Full width
        sidebardivider.Font = Theme.Fonts.Body
        sidebardivider.Text = name
        sidebardivider.TextColor3 = Theme.Colors.Text -- 🚀 Use standard text color
        sidebardivider.TextSize = 16 -- 🚀 Smaller
    ...
    -- 🚀 UPDATED: window:Section() now takes (name, subtitle, icon)
    function window:Section(name, subtitle, icon)
        ...
        sidebar2.BackgroundTransparency = 1 -- 🚀 Always transparent
        sidebar2.Size = UDim2.new(1, 0, 0, 50) -- 🚀 Taller for subtitle
        sidebar2.ZIndex = 2
        sidebar2.AutoButtonColor = false
        sidebar2.Text = "" -- Text is now handled by labels

        -- 🚀 NEW: Selection Bar (on the right)
        ...
        selectionBar.Position = UDim2.new(1, -3, 0.1, 0) -- 🚀 Positioned on the right
        selectionBar.Visible = false -- 🚀 Hide by default
        local sbCorner = Instance.new("UICorner", selectionBar)
        sbCorner.CornerRadius = Theme.Sizes.FullRadius
        createGradient(selectionBar, Theme.Colors.Primary, Theme.Colors.PrimaryLight) -- 🚀 Add gradient
        ...
        sectionIcon.ImageColor3 = Theme.Colors.Text -- 🚀 Default text color
        ...
        sectionSubtitle.TextColor3 = Theme.Colors.Gray -- 🚀 Darker text
        ...
        workareamain.Position = UDim2.new(0, 20, 0, 85) -- 🚀 Positioned below topbar with fixed offset
        workareamain.Size = UDim2.new(1, -40, 1, -100) -- 🚀 Fills space with fixed offset
        workareamain.ZIndex = 3
        workareamain.AutomaticCanvasSize = "Y"
        workareamain.CanvasSize = UDim2.new(0, 0, 0, 0)
        workareamain.ScrollBarThickness = 3 -- 🚀 v17: Use default scrollbar
        workareamain.ScrollBarImageColor3 = Theme.Colors.Text -- 🚀 v19: Changed to white-grey
        workareamain.Visible = false
        
        local pad = Instance.new("UIPadding", workareamain)
        pad.Name = "pad" -- 🚀 Give padding a name to ignore it later
        pad.PaddingTop = UDim.new(0, 10)
        pad.PaddingRight = UDim.new(0, 10) -- 🚀 v22: Add padding for scrollbar
        ...
        ull.Padding = UDim.new(0, 8) -- 🚀 v12: Increased vertical padding

        -- 🚀 NEW: Grid layout for maximized view
        local grid = Instance.new("UIGridLayout")
        grid.Name = "GridLayout"
        grid.Parent = nil -- 🚀 Start disabled
        grid.SortOrder = Enum.SortOrder.LayoutOrder
        grid.FillDirection = Enum.FillDirection.Vertical -- 🚀 Fill top-to-bottom first
        grid.StartCorner = Enum.StartCorner.TopLeft
        grid.CellPadding = UDim2.new(0, 5, 0, 5)
        grid.CellSize = UDim2.new(1, 0, 0, 37) -- 🚀 Default to 1 column, 37px height
        
        -- 🚀 v17: REMOVED all custom scrollbar code

        table.insert(workareas, workareamain)

        local sec = {}
        local layoutOrderCounter = 0 -- 🚀 NEW: Counter for sorting elements
        
        -- 🚀 UPDATED: sec:Select() for new labels and column logic
        function sec:Select()
            ...
            if currentSubtitle then currentSubtitle.TextColor3 = Theme.Colors.Text end -- Lighter gray
            if selectedIcon then selectedIcon.ImageColor3 = Theme.Colors.Primary end -- 🚀 Make icon purple

            for b, v in next, workareas do
                v.Visible = false
            end
            workareamain.Visible = true
            -- 🚀 v17: No scrollbar update needed

            -- 🚀 NEW: Rearrange elements based on maximized state
            ...
            local splitThreshold = 8 -- 🚀 Only split if there are more than 8 items

            -- 🚀 NEW DYNAMIC LOGIC:
            local workareaWidth = workareamain.AbsoluteSize.X
            local minColumnWidth = 300 -- The minimum width a column should be (adjust as needed)
            local numColumns = 1 -- 🚀 Default to 1 column
            ...
            if isMaximized and numColumns > 1 and componentCount > splitThreshold then
                -- 🚀 SPLIT LAYOUT
                ull.Parent = nil -- Disable list layout
                grid.Parent = workareamain -- Enable grid layout
                
                -- 🚀 Set grid cell size. 1/numColumns width, 37px height
                local totalPadding = 5 * (numColumns - 1)
                grid.CellSize = UDim2.new(1/numColumns, -totalPadding/numColumns, 0, 37) 
            else
                -- 🚀 SINGLE COLUMN LAYOUT
                grid.Parent = nil -- Disable grid layout
                ull.Parent = workareamain -- Enable list layout
            end
        end
        
        -- 🚀 v11: Store the `sec` API table
        table.insert(sectionAPIs, sec)

        -- 🚀 REPLACED: sec:Divider is now sec:Header()
        function sec:Header(name)
            layoutOrderCounter = layoutOrderCounter + 1
            local headerFrame = Instance.new("Frame")
            headerFrame.Name = "header"
            headerFrame.Parent = workareamain -- Headers stay in the main frame
            ...
            headerLabel.Text = "  " .. name -- 🚀 Add padding
            headerLabel.TextColor3 = Theme.Colors.Primary
            headerLabel.TextSize = 20
            headerLabel.TextXAlignment = Enum.TextXAlignment.Left
            createGradient(headerLabel, Theme.Colors.Primary, Theme.Colors.TextDark)
            
            local line = Instance.new("Frame")
            line.Name = "Line"
            line.Parent = headerFrame
            line.BackgroundColor3 = Theme.Colors.Gray
            ...
            lineGrad.Color = ColorSequence.new({
                ...
                ColorSequenceKeypoint.new(0.5, Theme.Colors.PrimaryLight),
                ColorSequenceKeypoint.new(1, Theme.Colors.Gray)
            })
            ...
            padding.Parent = workareamain -- Padding stays in the main frame
            padding.BackgroundTransparency = 1
            padding.Size = UDim2.new(1, 0, 0, 5)
            padding.LayoutOrder = layoutOrderCounter
        end
        
        function sec:Button(options)
            layoutOrderCounter = layoutOrderCounter + 1
            ...
            button.Name = "button"
            button.Parent = workareamain -- Initially parent to workareamain
            button.BackgroundColor3 = Theme.Colors.LightGray
            button.Size = UDim2.new(1, 0, 0, 37) -- 🚀 FIX: Reverted height
            button.ZIndex = 2
            button.Font = Theme.Fonts.Body
            button.Text = text
            button.TextColor3 = Theme.Colors.Primary
            button.TextSize = 21
            ...
            button.MouseEnter:Connect(function()
                TweenService:Create(button, TweenInfo.new(0.15), {BackgroundColor3 = Theme.Colors.Gray}):Play()
            end)

            button.MouseLeave:Connect(function()
                TweenService:Create(button, TweenInfo.new(0.15), {BackgroundColor3 = Theme.Colors.LightGray}):Play()
            end)
            ...
            if callback then
                button.MouseButton1Click:Connect(function()
                    task.spawn(function()
                        ...
                        button.TextColor3 = Theme.Colors.TextLight
                        task.wait(0.1)
        ...
        function sec:Label(name)
            ...
            label.Name = "label"
            label.Parent = workareamain -- Initially parent to workareamain
            label.BackgroundTransparency = 1
            label.Size = UDim2.new(1, 0, 0, 37) -- 🚀 FIX: Reverted height
        ...
        -- 🚀 REBUILT: sec:Switch (Glow Box Style)
        function sec:Switch(options)
            layoutOrderCounter = layoutOrderCounter + 1
            local text = options.Text or "Switch"
            local default = options.Default or false
            local callback = options.Callback

            local mode = default
            local toggleswitch = Instance.new("TextButton") -- 🚀 Changed to TextButton for click
            toggleswitch.Name = "toggleswitch"
            toggleswitch.Parent = workareamain -- Initially parent to workareamain
            toggleswitch.BackgroundTransparency = 1
            toggleswitch.Size = UDim2.new(1, 0, 0, 37) -- 🚀 FIX: Reverted height
            toggleswitch.Font = Theme.Fonts.Body
            toggleswitch.Text = text
            toggleswitch.TextColor3 = Theme.Colors.Text
            ...
            toggleswitch.LayoutOrder = layoutOrderCounter
            
            local checkBox = Instance.new("Frame")
            checkBox.Name = "CheckBox"
            checkBox.Parent = toggleswitch
            checkBox.BackgroundColor3 = Theme.Colors.LightGray
            checkBox.Position = UDim2.new(1, -30, 0.5, -10) -- 🚀 Aligned right
            checkBox.AnchorPoint = Vector2.new(1, 0.5)
            checkBox.Size = UDim2.new(0, 20, 0, 20)
            
            local uc_4 = Instance.new("UICorner")
            uc_4.CornerRadius = Theme.Sizes.SwitchRadius
            uc_4.Parent = checkBox

            -- 🚀 FIX: Removed non-existent "UIShadow" instance
            
            local function updateSwitch(runCallback)
                mode = not mode
                ...
                if mode then
                    -- Toggle ON
                    TweenService:Create(checkBox, tweenInfo, {BackgroundColor3 = Theme.Colors.Primary}):Play()
                else
                    -- Toggle OFF
                    TweenService:Create(checkBox, tweenInfo, {BackgroundColor3 = Theme.Colors.LightGray}):Play()
                end
            end
            
            -- Set initial state *without* running callback
            ...
            toggleswitch.MouseButton1Click:Connect(function() updateSwitch(true) end)
        end

        -- 🚀 FIXED: sec:TextField
        function sec:TextField(options)
            layoutOrderCounter = layoutOrderCounter + 1
            local text = options.Text or "TextField"
            local placeholder = options.Placeholder or "Type here..."
            local callback = options.Callback

            local textfield = Instance.new("TextLabel")
            textfield.Name = "textfield"
            textfield.Parent = workareamain -- Initially parent to workareamain
            textfield.BackgroundTransparency = 1
            textfield.Size = UDim2.new(1, 0, 0, 37) -- 🚀 FIX: Reverted height
            ...
            -- 🚀 v12: FIX: Position at 50% width, fill remaining 50%
            Frame_2.Position = UDim2.new(0.5, 0, 0.5, 0)
            Frame_2.AnchorPoint = Vector2.new(0, 0.5)
            Frame_2.Size = UDim2.new(0.5, 0, 1, -6) -- 6px vertical padding
            ...
            -- 🚀 FIX: Fill the parent frame
            TextBox.Position = UDim2.new(0, 10, 0, 0)
            TextBox.Size = UDim2.new(1, -20, 1, 0)
            TextBox.ClearTextOnFocus = false
            TextBox.Font = Theme.Fonts.Body
            TextBox.PlaceholderColor3 = Theme.Colors.Text
            TextBox.PlaceholderText = placeholder
            TextBox.Text = ""
            TextBox.TextColor3 = Theme.Colors.TextDark
            TextBox.TextSize = 21
        ...
        function sec:Slider(options)
            ...
            sliderContainer.Parent = workareamain -- Initially parent to workareamain
            sliderContainer.BackgroundTransparency = 1
            sliderContainer.Size = UDim2.new(1, 0, 0, 50) -- 🚀 Full width
            sliderContainer.Font = Theme.Fonts.Body
            sliderContainer.Text = text
            sliderContainer.TextColor3 = Theme.Colors.Text
            sliderContainer.TextSize = 21
            ...
            valueLabel.TextColor3 = Theme.Colors.TextDark
            ...
            thumb.InputBegan:Connect(function(input)
                if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                    ...
                    moveConn = UserInputService.InputChanged:Connect(function(moveInput)
                        ...
                        local newValue = min + (max - min) * math.clamp(percentage, 0, 1)
            ...
            updateSlider(currentValue, false) -- Set initial position
        end
        ...
        function sec:Dropdown(name, list, multi, callback)
            ...
            dropdown.Parent = workareamain -- Initially parent to workareamain
            dropdown.BackgroundTransparency = 1
            dropdown.Size = UDim2.new(1, 0, 0, 37) -- 🚀 FIX: Reverted height
            ...
            dropdownButton.Size = UDim2.new(0.5, 0, 1, -6) -- 6px vertical padding
            ...
            textPadding.PaddingRight = UDim.new(0, 25) -- 🚀 FIX: Changed to UDim
            ...
            arrow.Position = UDim2.new(1, -15, 0.5, 0) -- 🚀 Aligned right (of parent button)
            arrow.Size = UDim2.new(0, 12, 0, 12)
            arrow.Image = "rbxassetid://3926305904" -- ChevronDown
            ...
            optionsFrame.BackgroundTransparency = 0.1 -- 🚀 Darker
            optionsFrame.BorderSizePixel = 0
            -- 🚀 v12: FIX: This position logic is for the *pop-up*, so it's fine
            ...
            local function toggleDropdown(isOpen)
                if isOpen then
                    ...
                    -- 🚀 FIX: Make options frame same width as button
            ...
            for _, optionName in ipairs(list) do
                ...
                checkmark.BackgroundColor3 = Theme.Colors.Primary -- 🚀 Use Primary
                ...
                optionButton.MouseEnter:Connect(function() optionButton.BackgroundColor3 = Theme.Colors.Gray end)
                optionButton.MouseLeave:Connect(function() optionButton.BackgroundColor3 = Theme.Colors.LightGray end)
            end
